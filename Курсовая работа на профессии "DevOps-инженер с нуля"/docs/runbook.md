...
Документ описывает порядок действий и проверки для каждого требования диплома.
...
Каждое действие сопровождается проверкой, подтверждающей выполнение пункта ТЗ, что позволяет сдавать диплом с прозрачной трассировкой.
